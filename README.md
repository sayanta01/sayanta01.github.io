...
<html lang="en">
  ...
  <body>
      ...
      <section id="home">
	    ...
	    <div>
	      <h2 style="color:var(--highlight)">Hi there!</h2>  
	          <code>I am Sayanta, 18y old guy from india, who loves tinkering with computer and softwares.</code>  
	      
	      <h2 style="color:var(--highlight)" font-family="Twemoji">Love Linux. 🐧</h2>
	...
	<!-- <article> -->
	<!--   <h2 id="swim"> 🏊 And I started Swimming again.. </h2> -->
	<!--   <div> -->
	...
	<!--     <a href="blogs/swim.html">...Read More </a> -->
	<!--      -->
	<!--   </div> -->
 <!---->
	<!-- </article> -->
